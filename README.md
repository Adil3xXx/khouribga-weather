...
سكريبت واحد بلا مكتبات ثقيلة (stdlib فقط + `tzdata` للفترات الزمنية)، يجيب طقس **اليوم**
لمدينة **خريبكة** (32.881°N، 6.906°W) ويرسله على تيليجرام كل يوم على الساعة **7:00 صباحًا**
بتوقيت المغرب، باللغة العربية.
...
python3 weather_bot.py --selftest     # 123 فحص بلا أنترنت
...
وزارة الأوقاف المغربية (method 21). بلا مفاتيح، بلا تبعيات إضافية. الأولوية للمدن المغربية
(كود MA) ثم المطابقة العامة. كل رسالة صلاة كتبيّن الإحداثيات 📍 ديال المدينة.
